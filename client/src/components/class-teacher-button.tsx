...
const ClassTeacherButton = ({ classroom }: { classroom: IClassroom }) => {
  ...
  return (
    ...
    >
      <div
        className={`absolute flex items-center justify-center font-medium transition-opacity duration-300 ease-in-out px-4 py-2 rounded-md border-[1px] border-primary w-full overflow-hidden text-ellipsis ${
